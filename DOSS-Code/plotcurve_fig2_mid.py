...
for strgy in set_strategy:
    ...
    plt.title('Performance Profile on ' + 'middle dimensional' + ' Problems ', fontdict={'weight': 'normal', 'size': 12})
    plt.legend(fontsize=8)
...
for strgy in set_strategy:
    ...
    plt.title('Data Profile on ' + 'middle dimensional' + ' Problems ',
...
# plt.grid()
filename = "./figure/Fig2_midprofile%s.pdf" % str(tau)
