...
for strgy in set_strategy:
    ...
    plt.title('Performance Profile on ' + 'high dimensional' + ' Problems ', fontdict={'weight': 'normal', 'size': 12})
    plt.legend(fontsize=8)
...
for strgy in set_strategy:
    ...
    plt.title('Data Profile on ' + 'high dimensional' + ' Problems ',
...
# plt.grid()
filename = "./figure/Fig2_highprofile%s.pdf" % str(tau)
