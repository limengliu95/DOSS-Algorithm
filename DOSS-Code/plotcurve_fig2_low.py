...
for strgy in set_strategy:
    ...
    plt.title('Performance Profile on ' + 'low dimensional' + ' Problems ', fontdict={'weight': 'normal', 'size': 12})
    plt.legend(fontsize=8)
...
for strgy in set_strategy:
    ...
    plt.title('Data Profile on ' + 'low dimensional' + ' Problems ',
...
# plt.grid()
filename = "./figure/Fig2_lowprofile%s.pdf" % str(tau)
